...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:Taseen%40123@localhost/demoDB'
...
def users():
    if request.method == 'POST':
        try:
            ...
            # message using flash 
             flash(f"{request.form['emplotee.name']} successfully added!")
        except:
